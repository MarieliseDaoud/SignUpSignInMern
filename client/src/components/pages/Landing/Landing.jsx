          ...
          <div className="container mb-6 mt-1">
              <div className="row">
                  <div className="col-md-6 col-sm-12 mt-5">
                      ...
                      <Link  to="/Jobs" className="btn searchjobbtn btn-outline-dark mx-2 mb-2 py-3 px-4" role="button">SEARCH
                      JOBS</Link>
                  
                      <Link  to="/SignUp"className="btn postbtn mb-2 py-3 px-4" role="button">POST A JOB</Link>
  
                  </div>
                  <div className="col-md-6 col-sm-12 mt-5">
                  <img className="img-fluid" src={CoWorking}  alt="A SPACE MADE FOR YOU"/>
                </div>
              </div>
          </div>
      </section>
